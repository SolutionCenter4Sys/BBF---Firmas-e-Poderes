...
import { canonicalSchemaPreview } from "@/lib/mocks";
          ...
          <>
            <div className="page-header">
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                <button className="btn btn--secondary" type="button">Validar contra schema</button>
              </div>
            </div>
            ...
            <div className="card" style={{ padding: 0 }}>
              ...
              <div style={{ padding: 20 }}>
                {view === "tree" && (
                  <>
                    <TreeNode label={`📄 Documento`} value={doc.documentId} defaultOpen meta={doc.cnpj ? `CNPJ ${doc.cnpj}` : undefined}>
                        ...
                        {doc.poderes.map((p) => (
                          ...
                          >
                            ...
                            <TreeNode label="modoAssinatura" defaultOpen={true}>
                              ...
                              {p.modoAssinatura.n != null && <TreeNode label="n" value={String(p.modoAssinatura.n)} />}
                              {p.modoAssinatura.m != null && <TreeNode label="m" value={String(p.modoAssinatura.m)} />}
            ...
            <div className="card">
              ...
              <ul style={{ lineHeight: 1.8 }}>
                ...
                <li>Fonte: <code>GET /v1/documents/{"{id}"}/canonical</code>.</li>
              </ul>
            </div>
          </>
        );
